...
namespace ConsoleExt
{
	 ...
	 */
	CONSOLE_EXTENSIONS_API std::wstring ColorizeWstring(std::wstring wstr, ConsoleExt::ConsoleForegroundColor fColor);
	 ...
	 * @return Colorized wide string, using ASCII code
	 */
	CONSOLE_EXTENSIONS_API std::wstring ColorizeWstring(std::wstring wstr, ConsoleExt::ConsoleBackgroundColor bColor);
	 ...
	 * @return Colorized wide string, using ASCII code
	 */
	CONSOLE_EXTENSIONS_API std::wstring ColorizeWstring(std::wstring wstr, ConsoleExt::ConsoleForegroundColor fColor, ConsoleExt::ConsoleBackgroundColor bColor);
	 ...
	 */
	CONSOLE_EXTENSIONS_API std::wstring UnColorizeWstring(std::wstring wstr);
}
